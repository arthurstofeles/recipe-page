...
const Instructions = () => {
    return(
        <section>
            ...
            <a className="source" target="_blanket" href="https://sallysbakingaddiction.com/classic-cheesecake/">Source: https://sallysbakingaddiction.com/classic-cheesecake/</a>
        </section>
    )
}
